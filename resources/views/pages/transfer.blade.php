...
<div class="space-y-6">
    ...
    <div class="bg-[#191919] border border-[#2d2d2d] rounded-xl p-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-white">Переводы</h1>
                <p class="text-gray-400 mt-1">Управление переводами между обменниками</p>
            </div>
    ...
    <!-- AG-Grid контейнер -->
    <div class="bg-[#191919] border border-[#2d2d2d] rounded-xl p-6">
        <div id="transferGrid" class="ag-theme-alpine-dark" style="height: 600px; width: 100%; min-width: 800px;"></div>
    ...
    <div class="bg-[#191919] border border-[#2d2d2d] rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="text-center">
                <div class="text-2xl font-bold text-cyan-400" id="totalTransfers">0</div>
                <div class="text-sm text-gray-400">Всего переводов</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-green-400" id="completedTransfers">0</div>
                <div class="text-sm text-gray-400">Выполненные</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-blue-400" id="paidTransfers">0</div>
                <div class="text-sm text-gray-400">Оплаченные</div>
            </div>
            <div class="text-center">
                <div class="text-2xl font-bold text-red-400" id="returnTransfers">0</div>
